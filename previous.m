clear;
for xx=1:10
    x=ipcam('http://192.168.43.1:8080/video');
    im=snapshot(x);

    I100=imread('100_1.jpg'); %Training image for 100 Rs currency
    I500=imread('500_1.jpg'); %Training image for 500 Rs currency
    I50 = imread('50_1.jpg'); %Training image for 50 Rs currency
    I20 = imread('20_1.jpg'); %Training image for 20 Rs currency
    I10 = imread('10_1.jpg'); %Training image for 10 Rs currency
    ...
    I7=rgb2gray(I);
    I8=edge(I7,'canny');
    fname=['test' num2str(i) '.jpg'];
    imwrite(I8,fname,'jpg');
    imshow(I8);
